...
leaflet() %>% 
  ...
  addPolygons(
    ...
    fillOpacity = 0.5,
    weight = 0.5,
    label = ~paste0(NotBurdened, " No. of Unburdened Households = ", perc_not_burdened, " percent; ", Burdened, " No. of Burdened Households = ", perc_burdened, " percent; ", SeverelyBurdened, " No. of Severely Burdened Households = ", perc_severely_burdened, " percent" ),
    highlightOptions = highlightOptions(
      weight = 2
    ))
