...
Figure 5 indicates that from 2015 to 2019, there is a gradual decline of homeowner-occupied households and matched in turn by a steady increase in renter-occupied households. This suggests an increasing prevalence of "absent landlords" hence validating concerns raised over the increasing number of non owner-occupied properties in the city. Therefore, the enaction of the OPA could indeed mitigate against this trend.
